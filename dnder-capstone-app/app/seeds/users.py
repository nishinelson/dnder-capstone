...
def seed_PCs():
    ...
    userPC10 = PC(pcClass='worlock', experience='0-1', description='Pashenic, a doomsaying Dragonborn serial killer who values discovery, is motivated by their compatriots and is flawed by a secret crime.', groupType='in-person', userId=10)
...
def seed_DMs():
    userDM = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=1)
    userDM2 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=2)
    userDM3 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=3)
    userDM4 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=4)
    userDM5 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=5)
    userDM6 = DM(campaign='homebrew', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=6)
    userDM7 = DM(campaign='homebrew', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=7)
    userDM8 = DM(campaign='homebrew', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=8)
    userDM9 = DM(campaign='homebrew', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=9)
    userDM10 = DM(campaign='homebrew', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='in-person', description="We meet every other Saturday at 5pm. Bring snacks and I'll give your character inspiraiton.", userId=10)
    userDM11 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=11)
    userDM12 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=12)
    userDM13 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=13)
    userDM14 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=14)
    userDM15 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=15)
    userDM16 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=16)
    userDM17 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=17)
    userDM18 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=18)
    userDM19 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=19)
    userDM20 = DM(campaign='Curse of Strahd', resources='PHB, XGE, TCE', experience='0-1', partySize='4-6', groupType='remote', description="We meet every other Saturday at 5pm. Venmo me $1 and I'll give your character inspiraiton.", userId=20)
